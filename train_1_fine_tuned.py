...
DEV_ROOT = r"C:\Users\Nighil Natarajan\ckmam_proj\dcase_2026"

ADD_ROOT = r"C:\Users\Nighil Natarajan\ckmam_proj\dcase_2026_additional_training_set"
    ...
    for epoch in range(start_epoch, EPOCHS + 1):
        ...
        for batch in pbar:
            ...
            if len(z_src) > 1 and len(z_tgt) > 1:
                ...
                loss_dg = 0.015 * loss_coral + 0.005 * loss_mmd
            else:
                loss_dg = 0.0

            # ✅ DOMAIN ADVERSARIAL LOSS
            domain_logits = model.forward_domain(z1, lambda_=0.05)
            loss_domain = F.cross_entropy(domain_logits, domain_labels)

            if epoch <= WARMUP_EPOCHS + 3:
                loss = loss_raw + loss_dg + 0.02 * loss_domain
            else:
